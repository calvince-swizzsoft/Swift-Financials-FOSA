...
namespace Application.MainBoundedContext.DTO.BackOfficeModule
{
 ...
 {
  public Guid CustomerAccountId{get;set;} public string Cases{get;set;} public decimal Principal{get;set;} public int? DaysPastDue{get;set;} public int? MinimumCategory{get;set;} public int? Category{get;set;} public bool IsRestructured{get;set;} public LoanRiskReviewDTO Review{get;set;} public string BasisHash{get;set;} public List<string> Issues{get;set;}=new List<string>();
 }
