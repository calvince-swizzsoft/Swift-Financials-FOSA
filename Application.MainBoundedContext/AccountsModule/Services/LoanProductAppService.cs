...
namespace Application.MainBoundedContext.AccountsModule.Services
{
    ...
    public class LoanProductAppService : ILoanProductAppService
    {
        ...
        public IDictionary<string, string[]> ValidateLoanProduct(LoanProductDTO dto, ServiceHeader serviceHeader)
        {
            ...
            if (dto.LoanRegistrationMinimumGuarantors > dto.LoanRegistrationMaximumGuarantees) add("LoanRegistrationMinimumGuarantors", "Minimum guarantors cannot exceed maximum guarantees.");
